...
![Branch](https://img.shields.io/badge/Branch-experiment-brightgreen)
...
```bash
# Clone repository ini (branch experiment)
git clone -b experiment https://github.com/creativecoding-tech/Traffic-Jalanan.git
